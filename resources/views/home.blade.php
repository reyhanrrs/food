			...
			<div class="row tm-gallery">
				...
				<div id="tm-gallery-page-pizza" class="tm-gallery-page">
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
                            <img src="{{asset('templates/img/gallery/01.jpg')}}"  alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{asset('templates/img/gallery/02.jpg')}}" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{asset('templates/img/gallery/03.jpg')}}" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{asset('templates/img/gallery/05.jpg')}}" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{asset('templates/img/gallery/06.jpg')}}" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{asset('templates/img/gallery/07.jpg')}}" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{asset('templates/img/gallery/08.jpg')}}" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
				...
				<div class="row">
					<div class="col-md-6">
						<figure class="tm-description-figure">
							<img src="{{asset('templates/img/img-01.jpg')}}" alt="Image" class="img-fluid" />
						</figure>
					</div>
					<div class="col-md-6">
